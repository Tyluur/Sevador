 ...
 * @author Emperor
 * @author Wolfey <Made the most of the enum constants.>
 *
 */
public enum SummoningPouch {
	...
	private static final Map<Integer, SummoningPouch> POUCH_BY_NPC = new HashMap<Integer, SummoningPouch>();
	...
	static {
		for (SummoningPouch p : SummoningPouch.values())
			POUCH_BY_NPC.put(p.npcId, p);
	}
	...
	public static SummoningPouch getByNpc(int npcId) {
		return POUCH_BY_NPC.get(npcId);
	}
