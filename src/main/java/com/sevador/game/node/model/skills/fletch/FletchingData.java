...
public class FletchingData {
	public static enum Fletch {
		...
		HEADLESS_ARROWS(52, 314, new int[] { 53 }, new int[] { 1 },
				new double[] { 15 }, new Animation(-1)),

		BRONZE_ARROWS(39, 52, new int[] { 882 }, new int[] { 1 },
				new double[] { 0.4 }, new Animation(-1)),

		IRON_ARROWS(40, 52, new int[] { 884 }, new int[] { 15 },
				new double[] { 3.8 }, new Animation(-1)),

		STEEL_ARROWS(41, 52, new int[] { 886 }, new int[] { 30 },
				new double[] { 6.3 }, new Animation(-1)),

		MITHRIL_ARROWS(42, 52, new int[] { 888 }, new int[] { 45 },
				new double[] { 8.8 }, new Animation(-1)),

		ADAMANT_ARROWS(43, 52, new int[] { 890 }, new int[] { 60 },
				new double[] { 11.3 }, new Animation(-1)),

		RUNITE_ARROWS(44, 52, new int[] { 892 }, new int[] { 75 },
				new double[] { 13.8 }, new Animation(-1)),

		DRAGON_ARROWS(11237, 52, new int[] { 11212 }, new int[] { 90 },
