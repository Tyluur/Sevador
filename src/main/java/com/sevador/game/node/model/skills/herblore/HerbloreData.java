...
public class HerbloreData {
	...
	public enum Ingredients {
		...
		GUAM(249, new short[] { HerbloreData.VIAL, HerbloreData.SWAMP_TAR },
				new short[] { 91, 10142 }, new byte[] { 0, 19 }, new double[] {
						0, 30 }),

		MARRENTILL(251, new short[] { HerbloreData.VIAL, HerbloreData.SWAMP_TAR },
				new short[] { 93, 10143 }, new byte[] { 0, 31 }, new double[] {
						0, 42.5 }),

		TARROMIN(253, new short[] { HerbloreData.VIAL, HerbloreData.SWAMP_TAR },
				new short[] { 95, 10144 }, new byte[] { 0, 39 }, new double[] {
						0, 55 }),

		HARRALANDER(255, new short[] { HerbloreData.VIAL, HerbloreData.SWAMP_TAR },
				new short[] { 97, 10145 }, new byte[] { 0, 44 }, new double[] {
						0, 72.5 }),

		RANARR(257, new short[] { HerbloreData.VIAL }, new short[] { 99 },
				new byte[] { 0 }, new double[] { 0 }),

		TOADFLAX(2998, new short[] { HerbloreData.VIAL, HerbloreData.COCONUT_MILK },
				new short[] { 3002, 5942 }, new byte[] { 0, 0 }, new double[] {
						0, 0 }),

		SPIRIT_WEED(12172, new short[] { HerbloreData.VIAL },
				new short[] { 12181 }, new byte[] { 0 }, new double[] { 0 }),

		WERGALI(14854, new short[] { HerbloreData.VIAL }, new short[] { 14856 },
				new byte[] { 0 }, new double[] { 0 }),

		IRIT(259, new short[] { HerbloreData.VIAL, HerbloreData.COCONUT_MILK },
				new short[] { 101, 5951 }, new byte[] { 0, 0 }, new double[] {
						0, 0 }),

		AVANTOE(261, new short[] { HerbloreData.VIAL, 2436, 145, 147, 149 },
				new short[] { 103, 15308, 15309, 15310, 15311 }, new byte[] {
						0, 88, 88, 88, 88 }, new double[] { 0, 220, 220, 220,
						220 }),

		KWUARM(263, new short[] { HerbloreData.VIAL }, new short[] { 105 },
				new byte[] { 0 }, new double[] { 0 }),

		STARFLOWER(9017, new short[] { HerbloreData.VIAL }, new short[] { 9019 },
				new byte[] { 0 }, new double[] { 0 }),

		SNAPDRAGON(3000, new short[] { HerbloreData.VIAL }, new short[] { 3004 },
				new byte[] { 0 }, new double[] { 0 }),

		CADANTINE(265, new short[] { HerbloreData.VIAL }, new short[] { 107 },
				new byte[] { 0 }, new double[] { 0 }),

		LANTADYME(2481, new short[] { HerbloreData.VIAL, 2442, 163, 165, 167 },
				new short[] { 2483, 15316, 15317, 15318, 15319 }, new byte[] {
						0, 90, 90, 90, 90 }, new double[] { 0, 240, 240, 240,
						240 }),

		DWARF_WEED(267, new short[] { HerbloreData.VIAL, 2440, 157, 159, 161 },
				new short[] { 109, 15312, 15313, 15314, 15315 }, new byte[] {
						0, 89, 89, 89, 89 }, new double[] { 0, 230, 230, 230,
						230 }),

		CACTUS_SPINE(6016, new short[] { HerbloreData.COCONUT_MILK },
				new short[] { 5936 }, new byte[] { 0 }, new double[] { 0 }),

		TORSTOL(269, new short[] { HerbloreData.VIAL, 15309, 15313, 15317, 15321,
				15325 },
				new short[] { 111, 15333, 15333, 15333, 15333, 15333 },
				new byte[] { 0, 96, 96, 96, 96, 96 }, new double[] { 0, 1000,
						1000, 1000, 1000, 1000 }),

		CAVE_NIGHTSHADE(2398, new short[] { HerbloreData.COCONUT_MILK },
