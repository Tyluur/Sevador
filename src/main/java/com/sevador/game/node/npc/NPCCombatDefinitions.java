...
public class NPCCombatDefinitions {
	...
	public String combatDefinitions(NPCCombatDefinitions def) {
		return def.hitpoints + ": Attack anim " + def.attackAnim
				+ ", defence anim " + def.defenceAnim + ", death anim "
				+ def.deathAnim + ", atk delay " + def.attackDelay
				+ ", death delay " + def.deathDelay + ", respawn delay "
				+ def.respawnDelay + ", max hit " + def.maxHit
				+ ", attack style " + def.attackStyle + ", attack gfx "
				+ def.attackGfx + ", atk projectile " + def.attackProjectile
				+ ", agressive type " + def.agressivenessType
				+ ", death delay " + def.deathDelay + ", respawn delay "
				+ def.respawnDelay + ",";
	}
