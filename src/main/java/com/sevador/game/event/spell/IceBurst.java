...
/**
 * Handles the Ice burst spell event.
 * 
 * @author Emperor
 * 
 */
public final class IceBurst implements MagicSpell {

	/**
	 * The runes required to cast this spell.
	 */
	private static final Item[] RUNES = new Item[] { new Item(555, 4),
	...
	@Override
	public boolean init() {
		return EventManager.register(65558, this);
	}
	...
	public boolean handle(Interaction i) {
		...
		for (Target t : i.targets) {
			...
			t.graphic = new Graphic(363, 0, 0, t.entity.isNPC());
