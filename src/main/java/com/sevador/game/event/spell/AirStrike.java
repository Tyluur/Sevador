 ...
 * 
 */
public class AirStrike implements MagicSpell {

	/**
	 * The runes required to cast this spell.
	 */
	private static final Item[] RUNES = new Item[] { new Item(558, 1),
			new Item(556, 1) };
	...
	@Override
	public boolean init() {
		return EventManager.register(25, this);
	}
	...
	public boolean handle(Interaction i) {
		...
		t.projectile.add(Projectile.create(i.source, i.victim, 458, 22, 32, 60,
				speed, 0, 90));
