...
/**
 * Handles a Fire blast spell event.
 * @author Emperor
 *
 */
public final class FireBlast implements MagicSpell {

	/**
	 * The runes required to cast this spell.
	 */
	private static final Item[] RUNES = new Item[] {new Item(556, 4), new Item(554, 5), new Item(560, 1)};
	...
	@Override
	public boolean init() {
		return EventManager.register(63, this);
	}
	...
	public boolean handle(Interaction i) {
		...
		t.projectile.add(Projectile.create(i.source, i.victim, 2731, 30, 32, 52, speed, 3, 150));
		t.projectile.add(Projectile.create(i.source, i.victim, 2732, 30, 32, 52, speed, 20, 150));
