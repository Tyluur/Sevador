...
/**
 * Handles the Earth wave spell event.
 * @author Emperor
 *
 */
public class EarthWave implements MagicSpell {

	/**
	 * The runes required to cast this spell.
	 */
	private static final Item[] RUNES = new Item[] {new Item(556, 5), new Item(557, 7), new Item(565, 1)};
	 ...
	 * The start graphic.
	 */
	private static final Graphic GRAPHIC = new Graphic(2716, 0, 0, false);
	
	@Override
	public boolean init() {
		return EventManager.register(77, this);
	}
	...
	public boolean handle(Interaction i) {
		...
		t.graphic = new Graphic(2726, 96, 0, i.victim.isNPC());
		int speed = (int) (46 + i.source.getLocation().distance(i.victim.getLocation()) * 10);
		t.projectile.add(Projectile.create(i.source, i.victim, 2721, 38, 32, 54, speed, 0, 124));
