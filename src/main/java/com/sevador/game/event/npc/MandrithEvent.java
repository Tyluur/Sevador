 ...
 */
public class MandrithEvent implements NPCActionEvent {

	@Override
	public boolean init() {
		return EventManager.register(6537, this);
	}

	@Override
	public boolean handle(Player p, NPC npc, OptionType option) {
		p.getDialogueManager().startDialogue("Mandrith",
				new Object[] { npc.getId() });
		return true;
	}
