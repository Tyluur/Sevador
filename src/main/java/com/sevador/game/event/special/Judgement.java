 ...
 *
 */
public final class Judgement implements TypeHandler {
	 ...
	 * The animation.
	 */
	private static final Animation ANIMATION = new Animation(11989, 0, false, Priority.HIGHEST);
	
	/**
	 * The graphic.
	 */
	private static final Graphic GRAPHIC = new Graphic(2113, 0, 0, false);
	
	@Override
	public boolean init() {
		EventManager.register(11694, this);
		return EventManager.register(13450, this);
	}
	...
	public double getAccuracy(Entity e, Object... args) {
		return CombatType.MELEE.getHandler().getAccuracy(e, args) * 1.2499;
	}
