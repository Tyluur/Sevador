...
/**
 * Handles the Dragon longsword special attack event.
 * @author Emperor
 *
 */
public final class Cleave implements TypeHandler {
	 ...
	 * The animation.
	 */
	private static final Animation ANIMATION = new Animation(12033, 0, false, Priority.HIGHEST);
	
	/**
	 * The graphic.
	 */
	private static final Graphic GRAPHIC = new Graphic(2117, 96, 0, false);
	
	@Override
	public boolean init() {
		EventManager.register(1305, this);
		return EventManager.register(13475, this);
	}
	...
	public double getAccuracy(Entity e, Object... args) {
		return CombatType.MELEE.getHandler().getAccuracy(e, args) * 1.18;
	}

	@Override
	public double getMaximum(Entity e, Object... args) {
		return CombatType.MELEE.getHandler().getMaximum(e, args) * 1.2203;
	}
