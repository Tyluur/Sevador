...
dependencies {
	...
	implementation("com.thoughtworks.xstream:xstream:1.4.17") // You can replace with the desired version
	...
	implementation("org.jruby:jruby:9.3.2.0") // You can replace with the desired version
